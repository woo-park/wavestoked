...
//    }
    ...
    @Test
    public void Article_saved() throws Exception {
        String articleString = "<div>hi</div>";
        ...
        ArticleSaveRequestDto requestDto = ArticleSaveRequestDto.builder().articleString(articleString).author(author).skin(skinA).build();

        String url = "http://localhost:" + port + "/api/article/save";

//        HttpEntity<ArticleSaveRequestDto> requestEntity = new HttpEntity<>(requestDto);
...
//        assertThat(all.get(0).getArticleString()).isEqualTo(articleString);
//
//        System.out.println("get skin method");
//        System.out.println(all.get(0).getAuthor());
//        System.out.println(all.get(0));
//        Skin skinRes = all.get(0).getSkin();
////        System.out.println(skinRes);
////        assertThat(all.get(0).getSkin().getName()).isEqualTo(skinA.getName());


        Article article = articleRepository.findAll().get(0);
        String author1 = article.getAuthor();
        assertThat(author1).isEqualTo("wooooo");

        Skin skin = article.getSkin();
        assertThat(skin.getName()).isEqualTo("SkinA");
        System.out.println("seeee");

        System.out.println(skin.getArticles());
